...
>
> 這也是 RealSR-Quant **Page 2 (Quantization Recipes)** 的關鍵精神——不是「我做了多少 method」, 是「**我給 vendor 一個 decision package: recipe + reasoning + boundary**」。
...
>
> RealSR-Quant Page 2 「Quantization Recipes」 的關鍵精神:**不是 「5 個 method 」 的 demo,是 「給 vendor 的 4 個 recipe + 對應 reasoning + 3 條 boundary」 的 decision package**。
>
