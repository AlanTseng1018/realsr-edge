...
|---|---|---:|---:|---:|---:|---:|
| `edsr_fp16.onnx` | `tensorrt` | 27.438 | +0.001 | 3.31 +/- 0.09 | 1.59x faster | 2.63 |
| `edsr_fp16.onnx` | `cuda` | 27.438 | +0.001 | 3.94 +/- 2.09 | 1.18x faster | 2.63 |
| `edsr_fp16.onnx` | `cpu` | 27.439 | -0.000 | 45.83 +/- 2.53 | 1.04x faster | 2.63 |
| `edsr_fp32.onnx` | `tensorrt` | 27.439 | +0.000 | 5.27 +/- 2.16 | 1.00x faster | 5.24 |
| `edsr_fp32.onnx` | `cuda` | 27.439 | +0.000 | 4.65 +/- 1.40 | 1.00x faster | 5.24 |
| `edsr_fp32.onnx` | `cpu` | 27.439 | +0.000 | 47.64 +/- 2.66 | 1.00x faster | 5.24 |
| `edsr_int8_static.onnx` | `tensorrt` | 27.322 | +0.117 | 6.17 +/- 1.54 | 1.17x slower | 1.41 |
| `edsr_int8_static.onnx` | `cuda` | 27.322 | +0.117 | 6.41 +/- 1.78 | 1.38x slower | 1.41 |
| `edsr_int8_static.onnx` | `cpu` | 27.321 | +0.118 | 52.32 +/- 3.32 | 1.10x slower | 1.41 |
